          ...
          <Column className="center"style= {{padding: 0}}>
            <Container>
                ...
                <Container2 style={{ fontWeight:"bold",marginBottom: "20px",alignItems:"center",justifyContent:"center"}}>
                    ...
                    <p style={{fontSize: "16px",margin: "8px 0px 8px 15px",textAlign:"center"}}>(21) 3759-8100</p>
                </Container2>
                <FooterLinkCenter href="mailto:atendimento@hospitalemcor.com.br?Subject=Contato%20do%20Site"><Container2><i className="fa fa-envelope" style={{fontSize: "30px"}} /><span style={{fontSize: "14px",marginLeft: "12px"}}> atendimento@hospitalemcor.com.br </span></Container2>
                </FooterLinkCenter>
    		</Container>
          </Column>
          <Column>
            <Heading>Sobre o Hospital</Heading>
            <p style={{color: "white", textAlign: "justify",padding:"0 10px"}}>Qui dolor amet ipsum qui ullamco nisi aliquip non commodo eiusmod laboris labore ex aute. Aliquip excepteur Lorem nostrud reprehenderit deserunt deserunt dolor adipisicing elit.</p>
          </Column>
        </Row>
